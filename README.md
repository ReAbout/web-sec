...
## 目录
  * [0x00 技能栈](#0x00----)
  * [0x01 漏洞理解篇(Vulnerability)](#0x01-------vulnerability-)
    + [1.1 前端](#11---)
    + [1.2 后端](#12---)
    + [1.3 打造自己的知识库](#13---------)
  * [0x02 漏洞利用篇(Exploit)](#0x02-------exploit-)
    + [2.1 前端安全-XSS](#21------xss)
    + [2.2 前端安全-CSRF](#22------csrf)
    + [2.9 Server-side request forgery (SSRF)](#29-server-side-request-forgery--ssrf-)
    + [2.4  [注入]SQL注入&数据库漏洞利用](#24------sql----------)
    + [2.5 [注入]模板注入 Server Side Template Injection (SSTI)](#25----------server-side-template-injection--ssti-)
    + [2.6 [注入]命令注入&代码执行](#26--------------)
    + [2.7 [注入]Xpath注入](#27-----xpath--)
    + [2.8 XML External Entity (XXE)](#28-xml-external-entity--xxe-)
    + [2.9 文件上传漏洞](#29-------)
    + [2.10 反序列化漏洞](#210-------)
    + [2.11 包含漏洞](#211-----)
    + [2.12 PHP-特性漏洞](#212-php-----)
    + [2.13 Java-特性漏洞](#213-java-----)
    + [2.14 NodeJs-特性漏洞](#214-nodejs-----)
    + [2.15 Other](#215-other)
  * [0x03 代码审计篇(Audit)](#0x03-------audit-)
    + [3.1 PHP](#31-php)
    + [3.2 JAVA](#32-java)
    + [3.3 .NET](#33-net)
    + [3.4 Perl CGI](#34-perl-cgi)
  * [0x04 渗透篇(Penetration)](#0x04-----penetration-)
    + [4.1 网络预置](#41-----)
      - [4.1.1 代理客户端(环境准备)](#411------------)
      - [4.1.2 常规信息（单兵）](#412---------)
      - [4.1.3 资产搜索引擎（支撑）](#413-----------)
      - [4.1.4 移动端](#414----)
      - [4.1.5 近源渗透（WiFi）](#415------wifi-)
    + [4.2 网络接入(exp)](#42------exp-)
      - [4.2.1 漏洞验证（扫描器）](#421----------)
        * [4.2.1.1 主动式](#4211----)
        * [4.2.1.2 被动式](#4212----)
      - [4.2.2漏洞利用(1day)](#422-----1day-)
      - [4.2.3 字典](#423---)
    + [4.3 权限获取&提升](#43--------)
      - [4.3.1 Win](#431-win)
      - [4.3.2 Linux](#432-linux)
      - [4.3.3 Docker&Sandbox逃逸](#433-docker-sandbox--)
    + [4.4 权限维持&后门](#44--------)
      - [4.4.0 通用](#440---)
      - [4.4.1 Shell会话](#441-shell--)
